...
static struct android_app* android_app_create(ANativeActivity* activity,
    ...
    int r = pthread_setname_np( android_app->thread, "NativeAppGlue" );
    if ( r ) LOGE( "pthread_setname_np() failed with error code %d", r );
...
#if 1 // Taken from nvidia example
    (*android_app->activity->env)->DeleteGlobalRef(android_app->activity->env, android_app->appThreadThis);
#endif
